...
function slideShow(jsonDataCounty, jsonDataZip, maxRate){

    var slides = Slides.init(jsonDataCounty, jsonDataZip, maxRate);
...
var Slides = {
    ...
    initControls: function(){
        ...
        jQuery('.slide.start a').on('click', function(){
            event.preventDefault();
            self.nextSlide();
        });
    },
    ...
    hideHistogram: function(){
        jQuery('.histogram').animate({'opacity': 0}, 200, function(){
            jQuery(this).removeClass('over_slides');
        });
    },
    ...
    updateSlides: function(direction){
        ...
        var updaters = {
            0: how_common,
            1: geography_adult_county,
            2: geography_youth_county,
            3: geography_youth_zip,
            4: geography_youth_zip_imperial_valley,
            5: geography_youth_zip_bay_area,
            6: function(){},
            7: function(){},
            8: function(){},
            9: function(){},
        ...
        function geography_youth_zip_imperial_valley(){
            console.log('geography_youth_zip_imperial_valley');
        ...
        function geography_youth_zip_bay_area(){
            console.log('geography_youth_zip_bay_area');
